    ...
    return (
      <div className="container" style={homeStyles}>
        <Helmet>
          ...
          <meta
            name="description"
            content="Looking for wholesale price restaurant quality meat. At West Coast Meat Solutions we are committed to providing affordable meat to Perth families. We are Halal and MSA Certified. Open Saturday Morning to the public"
          />
        </Helmet>         
          <Row>
          <h1 className="text-center">This weeks specials</h1>
          <p className="text-center">Price specials are subject to availabilty and apply for this Saturday the 14th of October only.</p>
          <Col xs={12} md={12}>
          <SpecialsList products={products}/>
          </Col>
        </Row>
        <hr />
        <Row>
          <Col xs={12} md={9}>
            ...
            <p>
              For the <strong>Lowest Prices</strong> on premium quality meat
              Perth Markets Wholesale Clearance is the place to be. For the one
            ...
            <p>
              ...
              package, removing air from inside, and sealing the package. The
              intent of vacuum packing is usually to remove oxygen from the
              container to extend the shelf life of foods to reduce the volume
              of the contents and package. Vacuum packing reduces atmospheric
              oxygen, limiting the growth of aerobic bacteria or fungi, and
              preventing the evaporation of volatile components. Vacuum
              Packaging assists in the preservation of meat and improves
              tenderness as proteins begin to break down – known as the "ageing"
              process. Enjoy the superb eating quality of aged beef.
            </p>
            <h1>We have Goat in stock</h1>
            <p>
              Goat meat is lower in cholestrol, saturated fat and calories than
